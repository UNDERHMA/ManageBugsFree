...
Create Table BRSimilarBugReports (
    ...
    br_similar_bug_reports_id integer NOT NULL REFERENCES bugreports(bug_report_id),
	bug_report_id int NOT NULL,
...
Create Table LBTSimilarBugReports (
    ...
    lbt_similar_bug_reports_id integer NOT NULL REFERENCES lbtreports(lbt_report_id),
	lbt_report_id int NOT NULL,
	similar_bug_report_id int NOT NULL
);
